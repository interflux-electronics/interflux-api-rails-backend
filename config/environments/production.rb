Rails.application.configure do
  ...
  # Log mailer errors to specified file.
  # https://stackoverflow.com/questions/72480944/rails-how-to-configure-the-logger-for-the-rails-action-mailer
  config.action_mailer.logger = ActiveSupport::Logger.new('/var/www/api.interflux.com/logs/mailer.log')

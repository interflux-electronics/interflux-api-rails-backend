...
module V1
  module Admin
    class ImageIntegrationTest < ApplicationController
      # Public users should be able to fetch all images
      test '1' do
        assert_can_fetch_all true, 5, 6
      end

      # Public users should be able to fetch one image by ID
      test '2' do
        assert_can_fetch_one_by_id true
      end

      # Public users should be able to fetch one image by slug
      test '3' do
        assert_can_fetch_one_by_slug true
      end

      # Public users should NOT be able to create images
      test '4' do
        assert_can_create false
      end

      # Public users should NOT be able to update images
      test '5' do
        assert_can_update false
      end

      # Public users should NOT be able to delete images
      test '6' do

module Errors
  ...
  def route_not_found
    render_error(404, 'route-not-found', 'This route does not exist in Rails. Check `config/routes.rb` whether 1) it exists and 2) whether you added the hyphenated path.')
  end
